...
<header class="header">
  <div class="header__content">
    <div class="header__logo-container">
      ...
      <span class="header__logo-sub">Ryan Bender</span>
    </div>
...
<section class="home-hero">
  <div class="home-hero__content">
    <h1 class="heading-primary">Hey, My name is Ryan Bender</h1>
    <div class="home-hero__info">
      <p class="text-primary">
        I'm a Software Engineer / Developer 👨🏻 who loves building and developing applications and websites. I'd love to combine my passion for programming and learning with my software engineering skills to build scalable applications and websites for companies to deploy. I have a passion to learn everything new, contributing to the progress of mankind, and show creativity and possibilities in everything I do.
      </p>
    </div>
  ...
  <div class="main-container">
    <div class="main-footer__upper">
      ...
      <div class="main-footer__row main-footer__row-2">
        <h4 class="heading heading-sm text-lt">Ryan Bender</h4>
